...
class TrajectoryPoint {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.trajectoryPoint.forEach((val) => {
      bufferOffset = fsd_common_msgs.msg.CarState.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.trajectoryPoint[i] = fsd_common_msgs.msg.CarState.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.trajectoryPoint.forEach((val) => {
      length += fsd_common_msgs.msg.CarState.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'turtle_cmd/TrajectoryPoint';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.trajectoryPoint !== undefined) {
      ...
      for (let i = 0; i < resolved.trajectoryPoint.length; ++i) {
        resolved.trajectoryPoint[i] = fsd_common_msgs.msg.CarState.Resolve(msg.trajectoryPoint[i]);
      }
    }
    else {
