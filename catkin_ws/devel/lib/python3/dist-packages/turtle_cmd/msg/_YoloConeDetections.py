...
"""autogenerated by genpy from turtle_cmd/YoloConeDetections.msg. Do not edit."""
import codecs
import sys
...
class YoloConeDetections(genpy.Message):
  _md5sum = "e17c30018a8cba08b69b7dc1fb6a6c3d"
  _type = "turtle_cmd/YoloConeDetections"
...
string data
"""
  __slots__ = ['header','image_header','cone_detections']
  _slot_types = ['std_msgs/Header','std_msgs/Header','fsd_common_msgs/YoloCone[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,image_header,cone_detections
    ...
    """
    if args or kwds:
      super(YoloConeDetections, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = fsd_common_msgs.msg.YoloCone()
        _v7 = val1.x
        start = end
        end += 4
        (_v7.data,) = _get_struct_f().unpack(str[start:end])
        _v8 = val1.y
        start = end
        end += 4
        ...
        (_v9.data,) = _get_struct_f().unpack(str[start:end])
        _v10 = val1.height
        start = end
        end += 4
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v23.data = str[start:end].decode('utf-8', 'rosmsg')
        else:
