...
class CarState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('car_state_dt')) {
        ...
        this.car_state_dt = new fsd_common_msgs.msg.CarStateDt();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = fsd_common_msgs.msg.CarStateDt.serialize(obj.car_state_dt, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.car_state_dt = fsd_common_msgs.msg.CarStateDt.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += fsd_common_msgs.msg.CarStateDt.getMessageSize(object.car_state_dt);
    return length + 24;
  }

  static datatype() {
    // Returns string type for a message object
    return 'turtle_cmd/CarState';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.car_state_dt !== undefined) {
      resolved.car_state_dt = fsd_common_msgs.msg.CarStateDt.Resolve(msg.car_state_dt)
    }
    else {
      resolved.car_state_dt = new fsd_common_msgs.msg.CarStateDt()
    }
