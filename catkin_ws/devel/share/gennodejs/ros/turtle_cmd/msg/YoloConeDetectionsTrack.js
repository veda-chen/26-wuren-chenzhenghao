...
class YoloConeDetectionsTrack {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.cone_detections.forEach((val) => {
      bufferOffset = fsd_common_msgs.msg.YoloConeTrack.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_detections[i] = fsd_common_msgs.msg.YoloConeTrack.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.cone_detections.forEach((val) => {
      length += fsd_common_msgs.msg.YoloConeTrack.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cone_detections !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_detections.length; ++i) {
        resolved.cone_detections[i] = fsd_common_msgs.msg.YoloConeTrack.Resolve(msg.cone_detections[i]);
      }
    }
    else {
