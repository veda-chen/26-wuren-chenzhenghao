...
"""autogenerated by genpy from turtle_cmd/CanFrames.msg. Do not edit."""
import codecs
import sys
...
class CanFrames(genpy.Message):
  _md5sum = "5c94db952be9e0d7fac82c0d8b6f65da"
  _type = "turtle_cmd/CanFrames"
...
uint8[8] data"""
  ...
  _slot_types = ['std_msgs/Header','can_msgs/Frame[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CanFrames, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        val1.is_rtr = bool(val1.is_rtr)
        val1.is_extended = bool(val1.is_extended)
        val1.is_error = bool(val1.is_error)
        start = end
        end += 8
