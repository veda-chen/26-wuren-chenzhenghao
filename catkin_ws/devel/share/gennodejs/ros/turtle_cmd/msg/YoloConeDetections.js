...
class YoloConeDetections {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.cone_detections.forEach((val) => {
      bufferOffset = fsd_common_msgs.msg.YoloCone.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_detections[i] = fsd_common_msgs.msg.YoloCone.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.cone_detections.forEach((val) => {
      length += fsd_common_msgs.msg.YoloCone.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'turtle_cmd/YoloConeDetections';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cone_detections !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_detections.length; ++i) {
        resolved.cone_detections[i] = fsd_common_msgs.msg.YoloCone.Resolve(msg.cone_detections[i]);
      }
    }
    else {
