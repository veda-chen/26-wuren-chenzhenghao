// Generated by gencpp from file turtle_cmd/Feedback.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_FEEDBACK_H
#define TURTLE_CMD_MESSAGE_FEEDBACK_H
...
struct Feedback_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::Feedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::Feedback_<ContainerAllocator> const> ConstPtr;

}; // struct Feedback_

typedef ::turtle_cmd::Feedback_<std::allocator<void> > Feedback;

typedef boost::shared_ptr< ::turtle_cmd::Feedback > FeedbackPtr;
typedef boost::shared_ptr< ::turtle_cmd::Feedback const> FeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::Feedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::Feedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::Feedback_<ContainerAllocator1> & lhs, const ::turtle_cmd::Feedback_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::Feedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::Feedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::Feedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::Feedback_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::Feedback_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::Feedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc7937c93e48c88e3ULL;
  static const uint64_t static_value2 = 0x1894a7a84ffb18dbULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::Feedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::Feedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::Feedback_<ContainerAllocator>& v)
  {
...
#endif // TURTLE_CMD_MESSAGE_FEEDBACK_H
