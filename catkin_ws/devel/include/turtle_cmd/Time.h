// Generated by gencpp from file turtle_cmd/Time.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_TIME_H
#define TURTLE_CMD_MESSAGE_TIME_H
...
struct Time_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::Time_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::Time_<ContainerAllocator> const> ConstPtr;

}; // struct Time_

typedef ::turtle_cmd::Time_<std::allocator<void> > Time;

typedef boost::shared_ptr< ::turtle_cmd::Time > TimePtr;
typedef boost::shared_ptr< ::turtle_cmd::Time const> TimeConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::Time_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::Time_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::Time_<ContainerAllocator1> & lhs, const ::turtle_cmd::Time_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::Time_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::Time_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::Time_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::Time_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::Time_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::Time_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::Time_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::Time_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4cb510b1efb584ebULL;
  static const uint64_t static_value2 = 0x4466d8f45492e730ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::Time_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::Time_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::Time_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::Time_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::Time_<ContainerAllocator>& v)
  {
...
#endif // TURTLE_CMD_MESSAGE_TIME_H
