...
(cl:defmethod cl:initialize-instance :after ((m <AsState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AsState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_cmd-msg:<AsState> is deprecated: use turtle_cmd-msg:AsState instead.")))
...
(cl:defmethod mission-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:mission-val is deprecated.  Use turtle_cmd-msg:mission instead.")
  (mission m))

(cl:ensure-generic-function 'whichLap-val :lambda-list '(m))
(cl:defmethod whichLap-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:whichLap-val is deprecated.  Use turtle_cmd-msg:whichLap instead.")
  (whichLap m))

(cl:ensure-generic-function 'end-val :lambda-list '(m))
(cl:defmethod end-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:end-val is deprecated.  Use turtle_cmd-msg:end instead.")
  (end m))

(cl:ensure-generic-function 'finished-val :lambda-list '(m))
(cl:defmethod finished-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:finished-val is deprecated.  Use turtle_cmd-msg:finished instead.")
  (finished m))

(cl:ensure-generic-function 'cameraState-val :lambda-list '(m))
(cl:defmethod cameraState-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:cameraState-val is deprecated.  Use turtle_cmd-msg:cameraState instead.")
  (cameraState m))

(cl:ensure-generic-function 'lidarState-val :lambda-list '(m))
(cl:defmethod lidarState-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:lidarState-val is deprecated.  Use turtle_cmd-msg:lidarState instead.")
  (lidarState m))

(cl:ensure-generic-function 'insState-val :lambda-list '(m))
(cl:defmethod insState-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:insState-val is deprecated.  Use turtle_cmd-msg:insState instead.")
  (insState m))

(cl:ensure-generic-function 'sensorState-val :lambda-list '(m))
(cl:defmethod sensorState-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:sensorState-val is deprecated.  Use turtle_cmd-msg:sensorState instead.")
  (sensorState m))

(cl:ensure-generic-function 'ready-val :lambda-list '(m))
(cl:defmethod ready-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:ready-val is deprecated.  Use turtle_cmd-msg:ready instead.")
  (ready m))

(cl:ensure-generic-function 'count_time-val :lambda-list '(m))
(cl:defmethod count_time-val ((m <AsState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:count_time-val is deprecated.  Use turtle_cmd-msg:count_time instead.")
  (count_time m))
