// Generated by gencpp from file turtle_cmd/DrivingDynamics.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_DRIVINGDYNAMICS_H
#define TURTLE_CMD_MESSAGE_DRIVINGDYNAMICS_H
...
struct DrivingDynamics_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> const> ConstPtr;

}; // struct DrivingDynamics_

typedef ::turtle_cmd::DrivingDynamics_<std::allocator<void> > DrivingDynamics;

typedef boost::shared_ptr< ::turtle_cmd::DrivingDynamics > DrivingDynamicsPtr;
typedef boost::shared_ptr< ::turtle_cmd::DrivingDynamics const> DrivingDynamicsConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::DrivingDynamics_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::DrivingDynamics_<ContainerAllocator1> & lhs, const ::turtle_cmd::DrivingDynamics_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::DrivingDynamics_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe81485915cba41c8ULL;
  static const uint64_t static_value2 = 0x26595d00662f5ac3ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::DrivingDynamics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::DrivingDynamics_<ContainerAllocator>& v)
  {
...
#endif // TURTLE_CMD_MESSAGE_DRIVINGDYNAMICS_H
