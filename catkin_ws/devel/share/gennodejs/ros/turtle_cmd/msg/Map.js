...
let fsd_common_msgs = _finder('fsd_common_msgs');
...
class Map {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.cone_yellow.forEach((val) => {
      bufferOffset = fsd_common_msgs.msg.Cone.serialize(val, buffer, bufferOffset);
    });
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_yellow[i] = fsd_common_msgs.msg.Cone.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_blue[i] = fsd_common_msgs.msg.Cone.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_red[i] = fsd_common_msgs.msg.Cone.deserialize(buffer, bufferOffset)
    }
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_unknown[i] = fsd_common_msgs.msg.Cone.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.cone_yellow.forEach((val) => {
      length += fsd_common_msgs.msg.Cone.getMessageSize(val);
    });
  ...
  static Resolve(msg) {
    ...
    if (msg.cone_yellow !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_yellow.length; ++i) {
        resolved.cone_yellow[i] = fsd_common_msgs.msg.Cone.Resolve(msg.cone_yellow[i]);
      }
    }
    else {
    ...
    if (msg.cone_blue !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_blue.length; ++i) {
        resolved.cone_blue[i] = fsd_common_msgs.msg.Cone.Resolve(msg.cone_blue[i]);
      }
    }
    else {
      resolved.cone_blue = []
    ...
    if (msg.cone_red !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_red.length; ++i) {
        resolved.cone_red[i] = fsd_common_msgs.msg.Cone.Resolve(msg.cone_red[i]);
      }
    }
    else {
      resolved.cone_red = []
    ...
    if (msg.cone_unknown !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_unknown.length; ++i) {
        resolved.cone_unknown[i] = fsd_common_msgs.msg.Cone.Resolve(msg.cone_unknown[i]);
      }
    }
    else {
