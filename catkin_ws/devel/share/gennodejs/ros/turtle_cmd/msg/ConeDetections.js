...
class ConeDetections {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_detections[i] = fsd_common_msgs.msg.Cone.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static datatype() {
    ...
    return 'turtle_cmd/ConeDetections';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cone_detections !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_detections.length; ++i) {
        resolved.cone_detections[i] = fsd_common_msgs.msg.Cone.Resolve(msg.cone_detections[i]);
      }
    }
    else {
