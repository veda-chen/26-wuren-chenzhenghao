...
(cl:defmethod cl:initialize-instance :after ((m <ResAndAmi>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ResAndAmi)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_cmd-msg:<ResAndAmi> is deprecated: use turtle_cmd-msg:ResAndAmi instead.")))
...
(cl:defmethod resState-val ((m <ResAndAmi>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:resState-val is deprecated.  Use turtle_cmd-msg:resState instead.")
  (resState m))
