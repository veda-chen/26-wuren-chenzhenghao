...
(cl:defmethod cl:initialize-instance :after ((m <CarState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CarState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_cmd-msg:<CarState> is deprecated: use turtle_cmd-msg:CarState instead.")))
...
(cl:defmethod car_state-val ((m <CarState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:car_state-val is deprecated.  Use turtle_cmd-msg:car_state instead.")
  (car_state m))

(cl:ensure-generic-function 'car_state_dt-val :lambda-list '(m))
(cl:defmethod car_state_dt-val ((m <CarState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:car_state_dt-val is deprecated.  Use turtle_cmd-msg:car_state_dt instead.")
  (car_state_dt m))
