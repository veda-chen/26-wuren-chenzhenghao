...
(cl:defmethod cl:initialize-instance :after ((m <DecisionFlag>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DecisionFlag)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_cmd-msg:<DecisionFlag> is deprecated: use turtle_cmd-msg:DecisionFlag instead.")))
...
(cl:defmethod lap1State-val ((m <DecisionFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:lap1State-val is deprecated.  Use turtle_cmd-msg:lap1State instead.")
  (lap1State m))

(cl:ensure-generic-function 'lap2State-val :lambda-list '(m))
(cl:defmethod lap2State-val ((m <DecisionFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:lap2State-val is deprecated.  Use turtle_cmd-msg:lap2State instead.")
  (lap2State m))

(cl:ensure-generic-function 'mapState-val :lambda-list '(m))
(cl:defmethod mapState-val ((m <DecisionFlag>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:mapState-val is deprecated.  Use turtle_cmd-msg:mapState instead.")
  (mapState m))
