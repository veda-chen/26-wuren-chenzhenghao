// Generated by gencpp from file turtle_cmd/AsensingMessage.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_ASENSINGMESSAGE_H
#define TURTLE_CMD_MESSAGE_ASENSINGMESSAGE_H
...
struct AsensingMessage_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::AsensingMessage_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::AsensingMessage_<ContainerAllocator> const> ConstPtr;

}; // struct AsensingMessage_

typedef ::turtle_cmd::AsensingMessage_<std::allocator<void> > AsensingMessage;

typedef boost::shared_ptr< ::turtle_cmd::AsensingMessage > AsensingMessagePtr;
typedef boost::shared_ptr< ::turtle_cmd::AsensingMessage const> AsensingMessageConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::AsensingMessage_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::AsensingMessage_<ContainerAllocator1> & lhs, const ::turtle_cmd::AsensingMessage_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::AsensingMessage_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::AsensingMessage_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::AsensingMessage_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::AsensingMessage_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4955c4384f1d3f0dULL;
  static const uint64_t static_value2 = 0xac8b4faaad8aec51ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::AsensingMessage_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::AsensingMessage_<ContainerAllocator>& v)
  {
...
#endif // TURTLE_CMD_MESSAGE_ASENSINGMESSAGE_H
