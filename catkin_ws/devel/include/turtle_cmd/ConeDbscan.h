// Generated by gencpp from file turtle_cmd/ConeDbscan.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_CONEDBSCAN_H
#define TURTLE_CMD_MESSAGE_CONEDBSCAN_H
...
struct ConeDbscan_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::ConeDbscan_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::ConeDbscan_<ContainerAllocator> const> ConstPtr;

}; // struct ConeDbscan_

typedef ::turtle_cmd::ConeDbscan_<std::allocator<void> > ConeDbscan;

typedef boost::shared_ptr< ::turtle_cmd::ConeDbscan > ConeDbscanPtr;
typedef boost::shared_ptr< ::turtle_cmd::ConeDbscan const> ConeDbscanConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::ConeDbscan_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::ConeDbscan_<ContainerAllocator1> & lhs, const ::turtle_cmd::ConeDbscan_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::ConeDbscan_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::ConeDbscan_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::ConeDbscan_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::ConeDbscan_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x75070dcbcbfe5bd7ULL;
  static const uint64_t static_value2 = 0xb83a970d1d4c6e4aULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::ConeDbscan_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::ConeDbscan_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.corepts.size(); ++i)
    {
      if (true && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ", v.corepts[i]);
    }
    if (v.corepts.empty() || true)
      s << "]";
  }
...
#endif // TURTLE_CMD_MESSAGE_CONEDBSCAN_H
