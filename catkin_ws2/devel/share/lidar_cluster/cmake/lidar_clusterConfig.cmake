...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lidar_cluster' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/chen/Desktop/catkin_ws2/src/fsd_algorithm/ros/perception/lidar_cluster/${idir}'.  ${_report}")
    endif()
