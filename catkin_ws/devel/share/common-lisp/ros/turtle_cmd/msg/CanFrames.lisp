...
(cl:defmethod cl:initialize-instance :after ((m <CanFrames>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CanFrames)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_cmd-msg:<CanFrames> is deprecated: use turtle_cmd-msg:CanFrames instead.")))
...
(cl:defmethod Frames-val ((m <CanFrames>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_cmd-msg:Frames-val is deprecated.  Use turtle_cmd-msg:Frames instead.")
  (Frames m))
