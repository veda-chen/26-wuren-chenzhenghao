// Generated by gencpp from file turtle_cmd/Visualization.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_VISUALIZATION_H
#define TURTLE_CMD_MESSAGE_VISUALIZATION_H
...
struct Visualization_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::Visualization_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::Visualization_<ContainerAllocator> const> ConstPtr;

}; // struct Visualization_

typedef ::turtle_cmd::Visualization_<std::allocator<void> > Visualization;

typedef boost::shared_ptr< ::turtle_cmd::Visualization > VisualizationPtr;
typedef boost::shared_ptr< ::turtle_cmd::Visualization const> VisualizationConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::Visualization_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::Visualization_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::Visualization_<ContainerAllocator1> & lhs, const ::turtle_cmd::Visualization_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::Visualization_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::Visualization_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::Visualization_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::Visualization_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::Visualization_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::Visualization_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::Visualization_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::Visualization_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe50abcd3e258993fULL;
  static const uint64_t static_value2 = 0x1e09e11ebe66bc57ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::Visualization_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::Visualization_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::Visualization_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::Visualization_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::Visualization_<ContainerAllocator>& v)
  {
...
#endif // TURTLE_CMD_MESSAGE_VISUALIZATION_H
