// Generated by gencpp from file turtle_cmd/AsState.msg
// DO NOT EDIT!


#ifndef TURTLE_CMD_MESSAGE_ASSTATE_H
#define TURTLE_CMD_MESSAGE_ASSTATE_H
...
struct AsState_
{
  ...
  typedef boost::shared_ptr< ::turtle_cmd::AsState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::turtle_cmd::AsState_<ContainerAllocator> const> ConstPtr;

}; // struct AsState_

typedef ::turtle_cmd::AsState_<std::allocator<void> > AsState;

typedef boost::shared_ptr< ::turtle_cmd::AsState > AsStatePtr;
typedef boost::shared_ptr< ::turtle_cmd::AsState const> AsStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::turtle_cmd::AsState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::turtle_cmd::AsState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::turtle_cmd::AsState_<ContainerAllocator1> & lhs, const ::turtle_cmd::AsState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::AsState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::turtle_cmd::AsState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::AsState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::turtle_cmd::AsState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::AsState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::turtle_cmd::AsState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::turtle_cmd::AsState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::turtle_cmd::AsState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x91d4690a3eeefbccULL;
  static const uint64_t static_value2 = 0x594048a040c965e0ULL;
};

template<class ContainerAllocator>
struct DataType< ::turtle_cmd::AsState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::turtle_cmd::AsState_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# Header\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtle_cmd::AsState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::turtle_cmd::AsState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtle_cmd::AsState_<ContainerAllocator>& v)
  {
...
#endif // TURTLE_CMD_MESSAGE_ASSTATE_H
