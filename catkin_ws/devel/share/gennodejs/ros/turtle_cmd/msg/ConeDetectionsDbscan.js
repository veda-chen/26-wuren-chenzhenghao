...
class ConeDetectionsDbscan {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.cone_detections.forEach((val) => {
      bufferOffset = fsd_common_msgs.msg.ConeDbscan.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    for (let i = 0; i < len; ++i) {
      data.cone_detections[i] = fsd_common_msgs.msg.ConeDbscan.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    object.cone_detections.forEach((val) => {
      length += fsd_common_msgs.msg.ConeDbscan.getMessageSize(val);
    });
    return length + 4;
  }
  ...
  static datatype() {
    ...
    return 'turtle_cmd/ConeDetectionsDbscan';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cone_detections !== undefined) {
      ...
      for (let i = 0; i < resolved.cone_detections.length; ++i) {
        resolved.cone_detections[i] = fsd_common_msgs.msg.ConeDbscan.Resolve(msg.cone_detections[i]);
      }
    }
    else {
