...
(cl:defmethod cl:initialize-instance :after ((m <ControlCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtle_cmd-msg:<ControlCommand> is deprecated: use turtle_cmd-msg:ControlCommand instead.")))
